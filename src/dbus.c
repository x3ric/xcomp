...
#define CDBUS_SERVICE_NAME      "com.github.X3ric.comp"
#define CDBUS_INTERFACE_NAME    CDBUS_SERVICE_NAME
#define CDBUS_OBJECT_NAME       "/com/github/X3ric/xcomp"
...
#define CDBUS_ERROR_BADMSG_S    "Unrecognized command. Beware xcomp " \
...
#define cdbus_m_opts_get_do(tgt, apdarg_func) \
  ...
  if (!strcmp("version", target)) {
    cdbus_reply_string(ps, msg, XCOMP_VERSION);
    return true;
  }
